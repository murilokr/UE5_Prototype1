...
if __name__ == "__main__":
    ...
    parser.add_argument('initial_campos', nargs='?', type=str, default='164, 223, 58.913', help='Initial CamPos value as "x, y, z"')
    
    # Number of frames to generate
    parser.add_argument('num_frames', nargs='?', type=int, default=200, help='Number of frames to generate')
